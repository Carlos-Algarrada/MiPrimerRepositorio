''' Programa que lea una cantidad en segundos y muestres su equivalente en semanas, días
horas, minutos y segundos, según el formato de los siguientes ejemplos:
...
print(f"{seg_totales} equivalen a  [{semanas:2}] semanas, {dias} días, {horas:02}:{minutos:02}:{segundos:02}") 

#{variable:n} inserta el valor y asegura que tenga n espacios
#{variable:0n} inserta el valor y lo rellena con ceros a la izquierda. Así me aseguro 
# de que tenga al menos n digitos